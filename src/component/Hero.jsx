    ...
    <section className="flex flex-col-reverse md:flex-row items-center justify-between px-6 md:px-16 lg:px-24 py-16 bg-gradient-to-b from-black via-gray-900 to-black text-white min-h-screen relative overflow-hidden">
      ...
      >
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight">
          Hi, I'm{" "}
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-500 drop-shadow-[0_0_15px_rgba(0,255,100,0.7)]">
            Simran
          </span>
        </h1>
        ...
        <p className="text-lg sm:text-xl text-gray-300 leading-relaxed">
          Passionate about{" "}
          <strong className="text-green-400">Cybersecurity</strong> and{" "}
          <strong className="text-green-400">Web Development</strong>,
           I love protecting
          systems from digital threats while crafting clean, responsive, and innovative web
          experiences. My mission is to bridge security with design — building safe, smart,
          and stunning online spaces.
        </p>
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="px-6 py-3 bg-green-500 hover:bg-green-400 text-black font-semibold rounded-full shadow-[0_0_25px_rgba(0,255,100,0.4)] transition-all duration-300"
        >
          Learn More
        </motion.button>
      </motion.div>
